				...
				<React.Fragment key={index}>
					...
					{ index % 2 == 0 && (
						<>
							...
							rounded-[15px] px-10 py-5 backdrop-blur-[2px] md:col-span-1 self-stretch items-end">
					...
					{ index % 2 != 0 && (
						<>
							...
							rounded-[15px] px-10 py-5 backdrop-blur-[2px] md:col-span-1 self-stretch mb-20 md:mb-0">
								<h4 className="font-orbitron lowercase text-2xl tracking-wider">
									{header}
								</h4>
